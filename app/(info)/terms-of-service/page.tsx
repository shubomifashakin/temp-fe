          ...
          <div className="space-y-12 pb-12">
            <div className="space-y-4">
              ...
              <p className="text-foreground font-light text-sm leading-relaxed">
                By accessing and using Temp (&quot;Service&quot;), you accept
              ...
              <p className="text-foreground font-light text-sm leading-relaxed">
                ...
                your jurisdiction) to use our Services. If you are using the
            ...
            <div className="space-y-4">
              ...
              <p className="text-foreground font-light text-sm leading-relaxed">
                ...
                serve that content as necessary to provide the Service. You
                remain responsible for ensuring you have the rights to share any
                uploaded content.
              </p>
            </div>
